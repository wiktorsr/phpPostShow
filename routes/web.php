...
Route::get('/',[App\Http\Controllers\SiteController::class,'post'])->name('post');
Auth::routes();
...
Route::get('admin/posts/{post}', [PostController::class, 'destroy'])->name('admin_posts_destroy')->middleware('auth');
Route::get('admin/posts/edit/{post}', [PostController::class, 'edit'])->name('admin_posts_edit')->middleware('auth');
Route::post('admin/posts/edit/{post}', [PostController::class, 'update'])->name('admin_posts_update')->middleware('auth');
